...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? "#007aff" : "#679b9b",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#679b9b",
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? "#cde1f9" : "#679b9b",

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? "#007aff" : "#fff",
  toolbarDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#679b9b",
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? "#a7a6ab" : "#679b9b",
  get statusBarColor() {
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? "#007aff" : "#679b9b",
  ...
  radioSelectedColorAndroid: "#679b9b",
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? "#F8F8F8" : "#679b9b",
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? "#007aff" : "#fff",
  segmentTextColor: platform === PLATFORM.IOS ? "#007aff" : "#fff",
  segmentActiveTextColor: platform === PLATFORM.IOS ? "#fff" : "#679b9b",
  segmentBorderColor: platform === PLATFORM.IOS ? "#007aff" : "#fff",
  segmentBorderColorMain: platform === PLATFORM.IOS ? "#a7a6ab" : "#679b9b",
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#679b9b",
